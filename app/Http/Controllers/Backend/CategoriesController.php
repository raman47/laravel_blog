...
class CategoriesController extends BackendController
{
    ...
    public function store(Requests\CategoryStoreRequest $request)
    {
        ...
        return redirect("/backend/categories")->with("message", "New Category Added Successfully");
    }
    ...
    public function update(Requests\CategoryUpdateRequest $request, $id)
    {
        ...
        return redirect("/backend/categories")->with("message", "New Category Updated Successfully");
    }
    ...
    public function destroy(Requests\CategoryDestroyRequest $request, $id)
    {
        ...
        $category->delete();
        return redirect("/backend/categories")->with("message", "New Category Deleted Successfully");
